...
function analyzeSalesData(data, options) {
  ...
  if (
    ...
    throw new Error(
      "Данные должны содержать массивы sellers, products и purchase_records"
    );
  }
  ...
  // что-то сломалось, надо починить! return { sellerStats, sellerIndex, productIndex };
  ...
  const totalSellers = sellerStats.length; // Опечатка: было lenght
